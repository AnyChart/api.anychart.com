 ...
 * @param {(anychart.graphics.vector.Layer|anychart.graphics.vector.Stage)=} opt_parent Parent layer.
 * @return {anychart.graphics.vector.Element} Self instance for method chaining.
 */
anychart.graphics.vector.Element.prototype.parent;
 ...
 * @return {?anychart.graphics.vector.Cursor} Returns cursor type.
 */
anychart.graphics.vector.Element.prototype.cursor;
 ...
 * @return {boolean} Returns the visibility flag.
 */
anychart.graphics.vector.Element.prototype.visible;
 ...
 * @return {anychart.graphics.math.Rect} Returns rectangle settings.
 */
anychart.graphics.vector.Element.prototype.clip;
 ...
 * @return {boolean} The vector effect property.
 */
anychart.graphics.vector.Element.prototype.disableStrokeScaling;
 ...
 * @param {boolean=} opt_enabled [false] Vector effect property to set.
 * @return {anychart.graphics.vector.Element} Self instance for method chaining.
 */
anychart.graphics.vector.Element.prototype.disableStrokeScaling;
