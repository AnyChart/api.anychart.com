...
/**
 ...
 @example <t>stageOnly</t>
  var text = stage.text(10, 10, 'simple text');
  text.x(100)
...
/**
 ...
 @example <t>stageOnly</t>
  stage.text(30, 30, 'simple text').fontSize(16);
...
/**
 ...
 @example <t>stageOnly</t>
  stage.text(30, 30, 'simple text').fontFamily('Tahoma');
...
/**
 ...
 @example <t>stageOnly</t>
 stage.text(30, 30, 'simple text')
    .direction( anychart.graphics.vector.Text.Direction.LTR );
...
/**
 ...
 @example <t>stageOnly</t>
 stage.text(30, 30, 'simple text')
   .fontStyle(anychart.graphics.vector.Text.FontStyle.ITALIC);
...
/**
 ...
 @example <t>stageOnly</t>
 stage.text(30, 30, 'simple text')
    .fontVariant( anychart.graphics.vector.Text.FontVariant.SMALL_CAP );
...
/**
 ...
 @example <t>stageOnly</t>
  stage.text(30, 30, 'simple text')
    .decoration( anychart.graphics.vector.Text.Decoration.UNDERLINE );
...
/**
 ...
 @example <t>stageOnly</t>
   ...
   stage.text(30, 30, 'top text')
     .height(50)
     .width(60)
     .vAlign(anychart.graphics.vector.Text.VAlign.TOP);
   stage.text(30, 30, 'bottom text')
     .height(50)
     .width(60)
     .vAlign(anychart.graphics.vector.Text.VAlign.BOTTOM);
...
/**
 ...
 @example <t>stageOnly</t>
   stage.rect(30, 30, 160, 50);
   stage.text(30, 30, 'left text')
     .height(50)
     .width(160)
     .hAlign(anychart.graphics.vector.Text.HAlign.LEFT);
   stage.text(30, 30, 'right text')
     .height(50)
     .width(160)
     .hAlign(anychart.graphics.vector.Text.HAlign.RIGHT);
...
/**
 ...
 @example <t>stageOnly</t>
   stage.rect(30, 30, 90, 50);
   stage.text(30, 30, 'simple text without wrap')
     .height(50)
     .width(90)
     .textWrap(anychart.graphics.vector.Text.TextWrap.NO_WRAP);
   stage.text(30, 50, 'simple text with wrap')
     .height(50)
     .width(90)
     .textWrap(anychart.graphics.vector.Text.TextWrap.BY_LETTER);
...
/**
 ...
 @example <t>stageOnly</t>
   stage.text(30, 30, 'simple text with ellipsis')
     .height(50)
     .width(90)
     .textOverflow(anychart.graphics.vector.Text.TextOverflow.ELLIPSIS);
...
/**
 ...
 @example <t>stageOnly</t>
  stage.text(30, 30, 'You can\'t select this text')
    .selectable(false);
...
/**
 ...
 stage.html(10, 10,
   ...
   '<i>Italic</i> <br/>' +
   '<b>Bold</b> <br/>' +
   '<span style="color: rgba(200,0,0, 0.5); font-size: 20px;">Color and Size</span> <br/>' +
   '<i><span style="text-decoration: underline">Combined</span></i>',
   {fontSize: '15px'});
