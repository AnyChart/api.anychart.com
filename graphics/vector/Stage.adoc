...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.graphics.vector.Stage.prototype.useAnychartExporting
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Sets stage exporting mode, whether to use anychart.exports on export. DVF-4429.
 * @category Export
 * @ignoreDoc
 * @param {boolean=} opt_value Boolean flag whether to use anychart.exports.
 * @return {anychart.graphics.vector.Stage} Stage instance for chaining.
 * @since 8.8.0
 */
anychart.graphics.vector.Stage.prototype.useAnychartExporting;

/**
 * Returns useAnychartExporting flag value. DVF-4429.
 * @ignoreDoc
 * @return {boolean} useAnychartExporting flag.
 * @since 8.8.0
 */
anychart.graphics.vector.Stage.prototype.useAnychartExporting;
