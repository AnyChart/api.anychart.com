 ...
 * @param {function(this:SCOPE, EVENTOBJ):(boolean|undefined)} listener A function to execute each time the event is triggered.
 ...
 * @param {{key: number}} key The key returned by {@link anychart.graphics.vector.Stage#listen} or {@link anychart.graphics.vector.Stage#listenOnce}.
 * @return {boolean} Whether any listener was removed.
 * @since 7.7.0
 */
anychart.graphics.vector.Stage.prototype.unlistenByKey;
 ...
 * Works only with <a href="https://www.anychart.com/products/anychart/overview/">AnyChart product</a>
