 ...
 * @detailed Async rendering must be used when you have a lot of data
 ...
 * @example anychart.graphics.vector.Stage.getCoordinate
...
/**
 * Returns size.
 * @example anychart.graphics.vector.Stage.getSize
