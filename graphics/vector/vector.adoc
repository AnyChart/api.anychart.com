...
/**
 ...
 @property {(string|goog.color.names)} color Key color {@link https://www.w3schools.com/html/html_colors.asp}.
...
/**
 ...
 @property {(string|goog.color.names|undefined)} color Color. {@link https://www.w3schools.com/html/html_colors.asp}.
 @property {(number|undefined)} opacity Color opacity (0 to 1).
 */
...
/**
   ...
   */
anychart.graphics.vector.PaperSize.US_LETTER;
...
/**
   ...
   */
anychart.graphics.vector.PaperSize.A0;

/**
   * A1 measures 594 × 841 millimeters or 23.4 × 33.1 inches.
   */
anychart.graphics.vector.PaperSize.A1;

/**
   * A2 measures 420 × 594 millimeters or 16.5 × 23.4 inches.
   */
anychart.graphics.vector.PaperSize.A2;
...
/**
   ...
   */
anychart.graphics.vector.PaperSize.A3;
...
/**
   ...
   */
anychart.graphics.vector.PaperSize.A4;

/**
   * A5 measures 148 × 210 millimeters or 5.83 × 8.27 inches.
   */
anychart.graphics.vector.PaperSize.A5;
...
/**
   ...
   */
anychart.graphics.vector.PaperSize.A6;
