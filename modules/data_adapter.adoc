 ...
 * (https://cdn.anychart.com/releases/8.9.0/js/anychart-data-adapter.min.js for latest or https://cdn.anychart.com/releases/8.9.0/js/anychart-data-adapter.min.js for the versioned file)
