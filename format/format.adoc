 ...
 * @property {number|undefined} decimalsCount Desired number of decimals
 * @property {string|undefined} decimalPoint String to modify the decimal separator
 * @property {string|undefined} groupsSeparator String to separate every three digits.
 * @property {({factors:Array.<number>,suffixes:Array.<string>}|boolean|undefined)} scale Automatic scaling.
 * @property {boolean|undefined} zeroFillDecimals Whether to fill in the remaining decimal places zeros.
 * @property {string|undefined} scaleSuffixSeparator Additive between the suffix of scale and the number.
 * @property {boolean|undefined} useBracketsForNegative To Use brackets for negative numbers or no.
 */
anychart.format.NumberLocale;
