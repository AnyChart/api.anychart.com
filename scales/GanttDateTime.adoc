...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.scales.GanttDateTime.prototype.weeksEndWithYear
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the scale behavior regarding weeks limitation within a year. 
 * @example anychart.scales.GanttDateTime.weeksEndWithYear_get
 * @shortDescription Whether weeks end with year.
...
/**
 * Setter for the scale behavior regarding weeks limitation within a year.
 * @example anychart.scales.GanttDateTime.weeksEndWithYear_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.scales.GanttDateTime.prototype.weeksCycleMonthly
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the scale behavior regarding weeks limitation within a month boundaries. 
 * @example anychart.scales.GanttDateTime.weeksCycleMonthly_get
 * @shortDescription Whether weeks end with month.
 * @category Specific settings
 * @return {boolean} Current value.
 */
anychart.scales.GanttDateTime.prototype.weeksCycleMonthly;
...
/**
 * Setter for the scale behavior regarding weeks limitation within a month boundaries.
 * @example anychart.scales.GanttDateTime.weeksCycleMonthly_set
