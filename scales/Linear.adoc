 ...
 * @example anychart.scales.Linear.ticks_set_asObj Using object
 * @example anychart.scales.Linear.ticks_set_asArray Using array
 ...
 * @example anychart.scales.Linear.minorTicks_set_asObj Using object
 * @example anychart.scales.Linear.minorTicks_set_asArray Using array
 * @param {(Object|Array)=} opt_value An array of ticks or an object of settings to set.
 * @return {anychart.scales.Linear} Self instance for method chaining.
 */
anychart.scales.Linear.prototype.minorTicks;
