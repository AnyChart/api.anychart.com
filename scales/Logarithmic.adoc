...
/**
 * Getter for the current logarithmic base value.
 * @shortDescription Logarithmic base.
 * @category Specific settings
 * @example anychart.scales.Logarithmic.logBase_get
 * @return {number} The current logarithmic base.
 */
anychart.scales.Logarithmic.prototype.logBase;
 ...
 * @example anychart.scales.Logarithmic.logBase_set
 * @param {number=} opt_value [10] Logarithmic base to set. Takes any number greater than 1.
