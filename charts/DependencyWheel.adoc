 ...
 * A dependency wheel displays dependencies in a circular layout: nodes are placed on a ring and the dependencies between them are drawn as ribbon-like links.<br/>
 ...
 * The link is a ribbon that connects two nodes and represents the dependency between them.
