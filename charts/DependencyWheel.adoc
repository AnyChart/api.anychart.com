 ...
 * @listing See listing
 * chart.node({labels: {format: '{%name}: {%percent}%'}});
 ...
 * @listing See listing
 * var dropOverlappedLabels = chart.dropOverlappedLabels();
 ...
 * @category Coloring
 * @listing See listing
 * var gradientAngle = chart.gradientAngle();
 ...
 * @category Coloring
 * @listing See listing
 * var reverseGradient = chart.reverseGradient();
 ...
 * </ul>
 * @listing See listing
 * chart.tooltip({format: '{%from} -> {%to}: {%weight}'});
