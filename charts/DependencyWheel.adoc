 ...
 * Data points use the <b>from</b>, <b>to</b>, and <b>weight</b> fields.
 ...
 * @detailed Node labels support the {%name}, {%weight}, and {%percent} tokens, where {%percent} is the share of the node's total flow.
 ...
 * @return {(number|string)} The nodes width.
 * @since 9.0.0
 */
anychart.charts.DependencyWheel.prototype.nodeWidth;
 ...
 * @param {(number|string)=} opt_width [15] The nodes width in pixels or in percent of the wheel radius to set.
 * @return {anychart.charts.DependencyWheel} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.DependencyWheel.prototype.nodeWidth;
