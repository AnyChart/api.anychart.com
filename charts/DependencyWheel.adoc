 ...
 * The pad angle is the angular gap between neighboring nodes.
 * @example anychart.charts.DependencyWheel.padAngle_set
 * @param {number=} opt_angle [0.02] Pad angle in radians to set.
 * @return {anychart.charts.DependencyWheel} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.DependencyWheel.prototype.padAngle;
 ...
 * <ul>
 *   <li><b>'none'</b> - keep the order the nodes appear in the data. Set this value before the first draw: on a chart that is already drawn it keeps the order of the previous sorting.</li>
 *   <li><b>'asc'</b> - sort the nodes in ascending order.</li>
 *   <li><b>'desc'</b> - sort the nodes in descending order.</li>
 *   <li><b>Function</b> - custom comparator function, called with two nodes like the callback of Array.sort.</li>
 * </ul>
 * The 'asc' and 'desc' values and a comparator function all take effect on a chart that is already drawn. A comparator built from the positions of the nodes in the data restores the order of the data on a live chart.
 ...
 *   <li><b>'gradient'</b> - color the links with a gradient from the source node color to the target node color.</li>
 * </ul>
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.DependencyWheel.prototype.gradientAngle
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the gradient angle.
 * @shortDescription Gradient angle.
 * @category Coloring
 * @example anychart.charts.DependencyWheel.gradientAngle_get
 * @return {number} The gradient angle.
 * @since 9.0.0
 */
anychart.charts.DependencyWheel.prototype.gradientAngle;

/**
 * Setter for the gradient angle.<br/>
 * The gradient angle is used to color the links when the color mode is 'gradient'.
 * @example anychart.charts.DependencyWheel.gradientAngle_set
 * @param {number=} opt_angle [0] Gradient angle in degrees to set.
 * @return {anychart.charts.DependencyWheel} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.DependencyWheel.prototype.gradientAngle;
