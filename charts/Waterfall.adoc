 ...
 * @detailed Sets chart stack labels that displays sum of absolute values of all chart series. <br>
 *   <b>Note:</b> Labels will be visible only when chart has more then one series.
 * @example anychart.charts.Waterfall.stack_labels_set - Enable stack labels.
 * @example anychart.charts.Waterfall.stack_labels_position_set - Change labels position for stack labels.
