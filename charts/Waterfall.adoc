 ...
 * @param {(anychart.enums.WaterfallDataMode|string)=} opt_value ["diff"] Data mode.
 * @return {anychart.charts.Waterfall} Self instance for method chaining.
 * @since 7.14.0
 */
anychart.charts.Waterfall.prototype.dataMode;
 ...
 *    here as a hash map.
 * @return {anychart.core.cartesian.series.Waterfall} An instance of the created series.
 */
anychart.charts.Waterfall.prototype.waterfall;
