...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.drawTotalsAsAbsolute
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Whether totals should be drawn as absolute when theirs value are set.
 * @shortDescription Totals drawing mode setting.
 * @category Total settings
 * @listing See listing
 * var drawTotalsAsAbsolute = chart.drawTotalsAsAbsolute();
 * @return {boolean} Whether totals should be drawn as absolute, when theirs value are set.
 * @since 8.13.0
 */
anychart.charts.Waterfall.prototype.drawTotalsAsAbsolute;

/**
 * Sets totals drawing mode.<br/>
 * @example anychart.charts.Waterfall.drawTotalsAsAbsolute
 * @param {boolean=} value [false] Value for totals drawing mode.
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.addTotal
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Add total for the chart.
 * @shortDescription Add total for the chart.
 * @example anychart.charts.Waterfall.addTotal
 *
 * @category Total settings
 * @listing See listing
 * var total = chart.addTotal({ x: 'May', name: 'Subtotal' });
 *
 * @param {anychart.core.waterfall.TotalConfig} config - Total config.
 *
 * @return {anychart.core.waterfall.Total} Total instance.
 * @since 8.10.0
 */
anychart.charts.Waterfall.prototype.addTotal;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.removeTotal
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Removes total from the chart by total instance.
 * @shortDescription Removes total by instance.
 * @category Total settings
 * @example anychart.charts.Waterfall.removeTotal
 * @listing See listing
 * var total = chart.addTotal({ x: 'May', name: 'Subtotal' });
 * // Now chart has total after 'May' category.
 * chart.removeTotal(total);
 * // Now it not.
 *
 * @param {anychart.core.waterfall.Total} total - Total instance to remove.
 *
 * @return {anychart.charts.Waterfall} Chart instance.
 * @since 8.10.0
 */
anychart.charts.Waterfall.prototype.removeTotal;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.removeTotalAt
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Remove total from the chart by index.
 * @shortDescription Remove total by index.
 * @category Total settings
 * @example anychart.charts.Waterfall.removeTotalAt
 * @listing See listing
 * chart.addTotal({ x: 'May', name: 'Subtotal' });
 * chart.addTotal({ x: 'Dec', name: 'Total' });
 * // Chart has two total.
 *
 * chart.removeTotal(1);
 * // Last created total removed.
 *
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.getTotalAt
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Return total by passed index.
 * @shortDescription Return total by index.
 * @category Total settings
 * @example anychart.charts.Waterfall.getTotalAt
 * @listing See listing
 * chart.addTotal({ x: 'May', name: 'Subtotal' });
 * chart.addTotal({ x: 'Dec', name: 'Total' });
 * // Chart has two total.
 *
 * var decemberTotal = chart.getTotalAt(1);
 * var mayTotal = chart.getTotalAt(0);
 *
 * // Update totals colors.
 * decemberTotal.fill('#64b5f6');
 * mayTotal.fill('#1976d2');
 *
 * @param {number} index - Index of total to remove.
 * @return {anychart.charts.Waterfall} Chart instance.
 * @since 8.10.0
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.getAllTotals
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Returns array of all created totals.
 * @shortDescription Returns array of all created totals.
 * @example anychart.charts.Waterfall.getAllTotals
 * @category Total settings
 * @listing See listing
 * chart.addTotal({ x: 'May', name: 'Subtotal' });
 * chart.addTotal({ x: 'Dec', name: 'Total' });
 ...
 * // [mayTotal, decemberTotal]
 *
 * var totalsCategories = totals.map(total => total.x());
 * // ['May', 'Dec']
 *
 * @return {Array.<anychart.core.waterfall.Total>} Array of totals.
 * @since 8.10.0
 */
anychart.charts.Waterfall.prototype.getAllTotals;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.splitTotal
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @shortDescription Returns array of all created totals.
 * @detailed
 * Total splits must satisfy the conditions.
 * <ol>
 *   <li>Total must be created and it must reserve last category.</li>
 *   <li>Sum of all splits values must be equal or less total value.</li>
 *   <li>All splits configs must contain 'name' and 'value' field.</li>
 * </ol>
 * If sum of the all split less than total value, split with difference will be added.
 *
 * @example anychart.charts.Waterfall.getTotalAt
 *
 *
 * @category Total split
 *
 *
 * @listing See listing
 *
 ...
 * // Split total.
 * chart.splitTotal([
 *   {value: 50, name: 'Split1'},
 *   {value: 13, name: 'Split2'}
 * ]);
 *
 * @param {Array.<anychart.core.waterfall.SplitConfig>} splits
 *
 * @return {anychart.charts.Waterfall} Self instance.
 * @since 8.11.0
 */
anychart.charts.Waterfall.prototype.splitTotal;
...
/**
 * Returns array of all total splits.
 *
 * @shortDescription Returns array of all created totals.
 * @example anychart.charts.Waterfall.getTotalAt
 * @category Total split
 * @listing See listing
 * var splitData = chart.splitTotal();
 *
 * @return {Array.<anychart.core.waterfall.SplitConfig>} Array of split settings.
 * @since 8.11.0
 */
anychart.charts.Waterfall.prototype.splitTotal;
 ...
 * @example anychart.charts.Waterfall.addArrow
...
/**
 * Returns arrow instance at given index.
 * @category Arrow settings
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.boostEnabled
//
//----------------------------------------------------------------------------------------------------------------------
...
/**
 * Setter for the boost rendering state.<br/><b>null</b> (default) turns boost on automatically, but only when the series has more points than {@link anychart.charts.Waterfall#boostThreshold} <b>and</b> it is the only enabled series on the plot. <b>true</b> boosts unconditionally, bypassing both of those checks. <b>false</b> never boosts.<br/><b>Note</b>: Boost never applies to stacked, 3D, OHLC or range-based series, whatever this option is set to. Waterfall always stacks its series, so boost never engages on this chart. Boost draws on a Canvas layer; the WebGL renderer is an optional module loaded with anychart.loadModule('boost-webgl') and falls back to Canvas when it is not present.
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.boostThreshold
//
//----------------------------------------------------------------------------------------------------------------------
...
/**
 * Setter for the number of points above which boost switches on automatically.<br/>Only consulted while {@link anychart.charts.Waterfall#boostEnabled} is <b>null</b>; an explicit <b>true</b> or <b>false</b> ignores this value.
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.maxPointsRendered
//
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Waterfall.prototype.decimationAlgorithm
//
//----------------------------------------------------------------------------------------------------------------------
