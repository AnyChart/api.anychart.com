 ...
 *   <li><b>'expand'</b> - normalizes each stack to a constant height, filling the [-0.5, 0.5] band.</li>
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.StreamGraph.prototype.sortOrder
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the layer sort order.
 * @shortDescription Layer sort order.
 * @category Specific settings
 * @example anychart.charts.StreamGraph.sortOrder_get
 * @return {string|Function} The layer sort order.
 * @since 9.0.0
 */
anychart.charts.StreamGraph.prototype.sortOrder;

/**
 * Setter for the layer sort order.<br/>
 * The sort order defines the order the layers are stacked in, which decides the layers that end up in the middle of the stream, where a band bends the least and reads the best.
 * @detailed Supported values:
 * <ul>
 *   <li><b>'none'</b> - the layers keep the order they were added in, the first one on top.</li>
 *   <li><b>'asc'</b> - the layers are ranked by size, the total of their values with negative ones counted as positive, and the smallest one goes to the bottom.</li>
 *   <li><b>'desc'</b> - the same ranking upside down: the largest layer goes to the bottom.</li>
 *   <li><b>'inside-out'</b> - the layers are arranged so that the stream bends as little as possible, the order that goes with the 'wiggle' offset.</li>
 *   <li><b>function(a, b)</b> - a comparator function. It gets two layers and works like the comparator of Array.prototype.sort(), and the layer it sorts first goes to the bottom.</li>
 * </ul>
 * <ul>
 *   <li><b>Unsupported value:</b> discarded silently instead of raising an error, and the chart falls back to 'none'.</li>
 *   <li><b>Comparator that throws:</b> the layers keep the order they were added in and the error is reported in the console.</li>
 *   <li><b>Not the legend:</b> the method restacks the bands only, the legend goes on listing the layers in the order they were added.</li>
 * </ul>
 * See {@link anychart.charts.StreamGraph#offset} for the baseline the 'inside-out' order goes with.
 * @example anychart.charts.StreamGraph.sortOrder_set
 * @param {(string|Function)=} opt_order ['none'] Sort order to set.
 * @return {anychart.charts.StreamGraph} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.StreamGraph.prototype.sortOrder;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.StreamGraph.prototype.maxLabels
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @example anychart.charts.StreamGraph.maxLabels_get
...
/**
 * Setter for maximum labels.<br/>
 * The chart-level settings apply to the maximum labels of every layer at once, and each layer overrides them with its own {@link anychart.core.StateSettings#maxLabels}.
 ...
 * </ul>
 * <ul>
 *   <li><b>Layer labels:</b> the label the chart draws on each layer by default is its maximum label, built from the largest point of the layer, so these settings style the layer labels and <b>false</b> hides them all.</li>
 *   <li><b>Position:</b> the position() of the chart-level factory has no effect on the layer labels; set it on the maxLabels() of a layer's own series instead.</li>
 * </ul>
 * @example anychart.charts.StreamGraph.maxLabels_set_asBool Enable/Disable maximum labels
 * @example anychart.charts.StreamGraph.maxLabels_set_asObj Using object
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.StreamGraph.prototype.line
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Series
 * @detailed A Line series is not one of the layers of the stream: use it for a threshold or an average drawn over them.
 * <ul>
 *   <li><b>Not stacked:</b> the series keeps its own values instead of joining the stack.</li>
 *   <li><b>Not for the 'expand' offset:</b> that offset replaces the values of the layers with shares of the total, so a series that keeps its own values is drawn far outside the plot. The 'wiggle', 'silhouette', and 'zero' offsets cover it with the Y scale and it lands inside the plot.</li>
 * </ul>
 * See {@link anychart.charts.StreamGraph#offset} for the offsets.
 * @example anychart.charts.StreamGraph.line
 * @param {!(anychart.data.View|anychart.data.Set|Array|string)} data Data for the series.
 ...
 * @param {(Object|boolean|null)=} opt_settings [true] Legend settings.
 * @return {anychart.charts.StreamGraph} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.StreamGraph.prototype.legend;
