 ...
 *    here as a hash map.
 * @return {anychart.core.polar.series.Area} An instance of the class for method chaining.
 */
anychart.charts.Polar.prototype.area;
 ...
 * @param {Object.<string, (string|boolean)>=} opt_csvSettings [false] If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 * @return {anychart.core.polar.series.Line} An instance of the class for method chaining.
 */
anychart.charts.Polar.prototype.line;
 ...
 *    here as a hash map.
 * @return {anychart.core.polar.series.Marker} An instance of the class for method chaining.
 */
anychart.charts.Polar.prototype.marker;
 ...
 * @return {anychart.core.polar.series.Base} An instance of the class for method chaining.
 */
anychart.charts.Polar.prototype.getSeries;
