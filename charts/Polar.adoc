...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Polar.prototype.boostEnabled
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Polar.boostEnabled_get
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Polar.prototype.boostThreshold
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Polar.boostThreshold_get
...
/**
 * Setter for the number of points above which boost switches on automatically.<br/>Only consulted while {@link anychart.charts.Polar#boostEnabled} is <b>null</b>; an explicit <b>true</b> or <b>false</b> ignores this value.
 * @example anychart.charts.Polar.boostThreshold_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Polar.prototype.maxPointsRendered
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Polar.maxPointsRendered_get
 * @return {number} The current value.
 * @since 9.0.0
 */
anychart.charts.Polar.prototype.maxPointsRendered;
 ...
 * @example anychart.charts.Polar.maxPointsRendered_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Polar.prototype.decimationAlgorithm
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Polar.decimationAlgorithm_get
 ...
 * @example anychart.charts.Polar.decimationAlgorithm_set
