 ...
 * each node's size along the line is additionally scaled by its share of the largest node weight (with a 30% floor).
 ...
 *   <li><b>'gradient'</b> - the link is colored with a gradient from the source node color to the target node color.</li>
 * </ul>
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.ArcDiagram.prototype.gradientAngle
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Chart Coloring
 * @example anychart.charts.ArcDiagram.gradientAngle_get
 ...
 * The angle of the link gradient fill in degrees. Used with the 'gradient' color mode.
 * @example anychart.charts.ArcDiagram.gradientAngle_set
 * @param {number=} opt_angle [0] Gradient angle to set in degrees.
 * @return {anychart.charts.ArcDiagram} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.gradientAngle;
