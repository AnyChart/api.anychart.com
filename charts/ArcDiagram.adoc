 ...
 * @category Interactivity
 * @detailed Applies to nodes: pass a node name or an array of node names to select them.
 ...
 * @return {number|string} The node width.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.nodeWidth;
 ...
 * The node width is the thickness of the node bar.
 * @example anychart.charts.ArcDiagram.nodeWidth_set
 * @param {(number|string)=} opt_width [20] Node width to set in pixels or percent.
 * @return {anychart.charts.ArcDiagram} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.nodeWidth;
 ...
 * @param {string=} opt_direction ['up'] Arc direction to set.
 * @return {anychart.charts.ArcDiagram} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.arcDirection;
