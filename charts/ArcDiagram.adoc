 ...
 * @listing See listing
 * chart.link({hovered: {stroke: '2 #ffa000'}});
 ...
 * @category Size and Position
 * @listing See listing
 * var nodeSpacing = chart.nodeSpacing();
 ...
 * @category Specific settings
 * @listing See listing
 * var arcDirection = chart.arcDirection();
