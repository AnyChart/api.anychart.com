...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.ArcDiagram.prototype.orientation
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the chart orientation.
 * @shortDescription Chart orientation.
 * @category Size and Position
 * @example anychart.charts.ArcDiagram.orientation_get
 * @return {string} The chart orientation.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.orientation;
 ...
 * </ul>
 * @example anychart.charts.ArcDiagram.orientation_set
 * @param {string=} opt_orientation ['horizontal'] Orientation to set.
 * @return {anychart.charts.ArcDiagram} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.orientation;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.ArcDiagram.prototype.arcDirection
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the arc direction.
 * @shortDescription Arc direction.
 * @category Specific settings
 * @example anychart.charts.ArcDiagram.arcDirection_get
 * @return {string} The arc direction.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.arcDirection;

/**
 * Setter for the arc direction.
 * @detailed Supported values:
 * <ul>
 *   <li><b>'up'</b> or <b>'down'</b> - for the horizontal orientation.</li>
 *   <li><b>'right'</b> or <b>'left'</b> - for the vertical orientation.</li>
 * </ul>
 * @example anychart.charts.ArcDiagram.arcDirection_set
 * @param {string=} opt_direction ['up'] Arc direction to set. The default bow direction is 'up' for the horizontal orientation and 'right' for the vertical one.
 * @return {anychart.charts.ArcDiagram} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.ArcDiagram.prototype.arcDirection;
