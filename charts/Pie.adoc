...
/**
 * Setter for the hatch fill palette settings.<br/>
...
/**
 * Setter for the fill settings in the hover state using an array or a string.
 * {docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
...
/**
 * Getter for the outside labels connectors stroke settings.
...
/**
 * Setter for the outside labels connectors stroke settings.
