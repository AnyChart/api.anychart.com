 ...
 * @param {(string|null|GroupingFunction)=} opt_value [null] Filter function or disable value.
 * @param {string=} opt_name Group name.
 * @return {anychart.charts.Pie} Self instance for method chaining.
 */
anychart.charts.Pie.prototype.group;
 ...
 * @param {(string|number|innerRadiusFunction)=} opt_value [0] The value of the inner radius in pixels, percents or
