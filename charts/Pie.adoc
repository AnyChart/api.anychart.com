 ...
 * @example anychart.charts.Pie.data_set_asObj Using table data
 * @param {(anychart.data.View|anychart.data.Mapping|anychart.data.Set|anychart.data.TableData|Array)=} opt_value Data for the chart.
