 ...
 * @example anychart.charts.Map.colorRange_set_asInst Using instance.
 * @param {(anychart.core.ui.ColorRange|Object)=} opt_value [false] Chart marker palette settings to set.
 * @return {anychart.charts.Map} Self instance for method chaining.
 * @since 7.6.0
 */
anychart.charts.Map.prototype.colorRange;
