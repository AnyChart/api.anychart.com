 ...
 * @return {(anychart.core.utils.UnboundRegionsSettings|anychart.enums.MapUnboundRegionsMode|string)} The current settings for regions.
 * @since 7.6.0
 */
anychart.charts.Map.prototype.unboundRegions;
 ...
 * @param {(anychart.palettes.Markers|Object|Array.<anychart.enums.MarkerType|string>)=} opt_value Map marker palette settings to set.
 * @return {!anychart.charts.Map} Self instance for method chaining.
 * @since 7.6.0
 */
anychart.charts.Map.prototype.markerPalette;
 ...
 * @param {(anychart.enums.MapSeriesType|string)=} opt_value Series type.
 * @return {anychart.charts.Map} Self instance for method chaining.
 * @since 7.8.0
 */
anychart.charts.Map.prototype.defaultSeriesType;
 ...
 * @category Size and Position
 * @param {(Object|Function|anychart.enums.MapProjections|string)} Projection name, or projection string representation,
 ...
 * @param {anychart.charts.Map} Self instance for method chaining.
 * @since 7.9.0
 */
anychart.charts.Map.prototype.crs;
 ...
 * @param {(anychart.scales.Geo|Object)=} opt_value ["geo"] Scale to set.
 * @return {anychart.scales.Geo} Map geo scale value.
 * @since 7.12.0
 */
anychart.charts.Map.prototype.scale;
