 ...
 * See the list of supported projections and samples at {@link https://docs.anychart.com/latest/Maps/Projection}
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Map.prototype.getCurrentPath
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Returns bread crumbs path.<br/>
 * Returns path of the visited levels of drill down from the root map to the current level.
 * @category Data
 * @example anychart.charts.Map.getCurrentPath
