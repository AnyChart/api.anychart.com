 ...
 * @return {(anychart.data.Tree|anychart.data.TreeView)} Returns current data tree.
 */
anychart.charts.Gantt.prototype.data;
 ...
 * @detailed ZoomTo() method works only when scale is calculated. It should be used after the draw() method..<br/>
