 ...
 * @detailed Learn more about coloring at:<br/>
 * {@link https://docs.anychart.com/__VERSION__/General_settings/Elements_Fill}<br/>
 * <b>Note:</b> You can't use image for row hover fill.
 ...
 * @detailed Learn more about coloring at:<br/>
 * {@link https://docs.anychart.com/__VERSION__/General_settings/Elements_Fill}<br/>
 * <b>Note:</b> You can't use image for row selected fill.
