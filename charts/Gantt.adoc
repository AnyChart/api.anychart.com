...
/**
 * Setter for the number of visible rows above which boost switches on automatically.<br/>Only consulted while {@link anychart.charts.Gantt#boostEnabled} is <b>null</b>; an explicit <b>true</b> or <b>false</b> ignores this value.
