 ...
 * @param {(string|Object)=} opt_value [anychart.scales.StockOrdinalDateTime] X-scale to set.
 * @return {anychart.charts.Stock} Self instance for method chaining.
 * @since 7.7.0
 */
anychart.charts.Stock.prototype.xScale;
 ...
 * If the value is set to 'true', then support for each point on the series.<br/>
