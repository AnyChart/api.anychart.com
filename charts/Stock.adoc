 ...
 * @detailed <b>Note</b>: Unit value and range type value works only after {@link anychart.charts.Stock#draw} is called.
 * @category Specific settings
 ...
 * @param {number|string|Date|anychart.enums.StockRangeType|string|anychart.enums.Interval} typeOrUnitOrStart Start value or range type, or interval.
 * @param {number|string|Date|boolean} opt_endOrCountOrDispatchEvent End value or count of years, or dispatch event.
 * @param {(anychart.enums.StockRangeAnchor|string|boolean)=} opt_anchorOrDispatchEvent Dispatch event or range anchor.
