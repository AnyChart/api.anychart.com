...
/**
 * Setter for the сolor scale.
 * @detailed <b>Note</b>: If you sets a {@link anychart.charts.HeatMap#fill}, that method color scale will not work.
 ...
 * @detailed <b>Note</b>: If you set not "center" labels position, you will have to set "crop" or "alwaysShow" display
 ...
 * @detailed <b>Note</b>: If you sets a fill, that method {@link anychart.charts.HeatMap#colorScale} will not work.
 ...
 * <b>Note</b>: If you sets a fill, that method {@link anychart.charts.HeatMap#colorScale} will not work.
...
/**
 * Getter for current fill color on hover state.
...
/**
 * Getter for the stroke on hover state.
...
/**
 * Setter for the stroke on hover state using function.
 * {docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
...
/**
 * Setter for the stroke on hover state.
 * {docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
 ...
 * @detailed Sets chart labels settings depend on of parameter's type:
 * <ul>
...
/**
 * Getter for the current chart data labels on hover state.
...
/**
 * Setter for chart data labels on hover state.
 * @detailed Sets chart labels settings depend on of parameter's type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable chart labels.</li>
 *   <li><b>object</b> - sets chart labels settings.</li>
...
/**
 * Getter for data markers on hover state.
...
/**
 * Setter for data markers on hover state.
 * @detailed Sets chart markers settings depend on of parameter's type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable chart markers.</li>
 *   <li><b>object</b> - sets chart markers settings.</li>
 ...
 * @detailed Sets chart X scroller settings depend on of parameter's type:
 * <ul>
 ...
 * @detailed Sets chart Y scroller settings depend on of parameter's type:
 * <ul>
