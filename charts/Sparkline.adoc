 ...
 * @param {(anychart.enums.ScaleTypes|string|anychart.scales.Base|Object)=} opt_value ["ordinal"] X-scale to set.
 ...
 * @param {(anychart.enums.ScaleTypes|string|anychart.scales.Base|Object)=} opt_value ["linear"] Y Scale to set.
 * @return {anychart.charts.Sparkline} Self instance for method chaining.
 */
anychart.charts.Sparkline.prototype.yScale;
