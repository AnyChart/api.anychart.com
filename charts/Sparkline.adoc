 ...
 * (https://cdn.anychart.com/releases/v8/js/anychart-exports.min.js for latest or https://cdn.anychart.com/releases/8.7.1/js/anychart-exports.min.js for the versioned file)
