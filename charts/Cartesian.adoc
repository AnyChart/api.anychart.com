 ...
 *  </ul> <br/>
 * To get Bar Chart mode you have to swap axes using {@link anychart.core.axes.Linear#orientation} method and
 * grids using {@link anychart.core.grids.Linear#layout} method.
