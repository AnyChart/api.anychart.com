...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.hoverLabels
//  
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @shortDescription Labels settings. 
 * @category Point Elements 
 * @example anychart.charts.Cartesian.hoverLabels_get
 * @return {anychart.core.ui.LabelsFactory} Labels instance.
 * @since 7.13.1 
 */
 anychart.charts.Cartesian.prototype.hoverLabels;  
 ...
 * </ul>
 * @example anychart.charts.Cartesian.hoverLabels_set_asBool Enable/Disable chart labels
 * @example anychart.charts.Cartesian.hoverLabels_set_asObj Using object
 * @param {(Object|boolean|null)=} opt_value Series data labels settings.
 * @return {anychart.charts.Cartesian} Self instance for method chaining.
 * @since 7.13.1 
 */
...
//---------------------------------------------------------------------------------------------------------------------- 
//
// anychart.charts.Cartesian.prototype.selectLabels 
//
//----------------------------------------------------------------------------------------------------------------------  
 ...
 * @shortDescription Labels settings.
 * @category Point Elements 
 * @example anychart.charts.Cartesian.selectLabels_get
 * @return {anychart.core.ui.LabelsFactory} Labels instance. 
 * @since 7.13.1 
 */
anychart.charts.Cartesian.prototype.selectLabels;
 ...
 *   <li><b>object</b> - sets chart hover labels settings.</li>
 * </ul>
 * @example anychart.charts.Cartesian.selectLabels_set_asBool Enable/Disable chart labels
 * @example anychart.charts.Cartesian.selectLabels_set_asObj Using object
 * @param {(Object|boolean|null)=} opt_value Series data labels settings.
 * @return {anychart.core.ui.LabelsFactory} Labels instance. 
 * @since 7.13.1 
 */
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.Cartesian.prototype.getXScales
//
//----------------------------------------------------------------------------------------------------------------------
