...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.dumbbell
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Adds Dumbbell series.
 * @category Series
 * @detailed The Dumbbell series uses the <b>x</b>, <b>low</b> and <b>high</b> data fields.
 * @example anychart.charts.Cartesian.dumbbell
 * @param {!(anychart.data.View|anychart.data.Set|Array|string)=} data Data for the series.
 * @param {(anychart.enums.TextParsingMode|string|anychart.data.TextParsingSettings)=} opt_csvSettings If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 * @return {anychart.core.cartesian.series.Dumbbell} An instance of the created series.
 * @since 9.0.0
 */
anychart.charts.Cartesian.prototype.dumbbell;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.lollipop
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Adds Lollipop series.
 * @category Series
 * @detailed The Lollipop series uses the <b>x</b> and <b>value</b> data fields.
 * @example anychart.charts.Cartesian.lollipop
 * @param {!(anychart.data.View|anychart.data.Set|Array|string)=} data Data for the series.
 * @param {(anychart.enums.TextParsingMode|string|anychart.data.TextParsingSettings)=} opt_csvSettings If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 * @return {anychart.core.cartesian.series.Lollipop} An instance of the created series.
 * @since 9.0.0
 */
anychart.charts.Cartesian.prototype.lollipop;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.boostEnabled
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Cartesian.boostEnabled_get
...
/**
 * Setter for the boost rendering state.<br/><b>null</b> (default) turns boost on automatically, but only when the series has more points than {@link anychart.charts.Cartesian#boostThreshold} <b>and</b> it is the only enabled series on the plot. <b>true</b> bypasses both of those checks, but not the exclusions in the note below. <b>false</b> never boosts.<br/><b>Note</b>: Boost never applies to stacked, 3D, OHLC or range-based series, whatever this option is set to. Boost is also refused to a series whose drawer has no boost renderer of its own: area, spline area, step area, jump line, stick, box, heat map, timeline moment, timeline range and the polar flavor of column. Such a series never gets a boost canvas and draws through SVG; setting this to <b>true</b> on one of them only prints a console warning naming the series type. Boost draws on a Canvas layer; the WebGL renderer is an optional module loaded with anychart.loadModule('boost-webgl') and falls back to Canvas when it is not present.
 * {docs:Common_Settings/Performance_Boost}Learn more about boost and decimation.{docs}
 * @example anychart.charts.Cartesian.boostEnabled_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.boostThreshold
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Cartesian.boostThreshold_get
...
/**
 * Setter for the number of points above which boost switches on automatically.<br/>Only consulted while {@link anychart.charts.Cartesian#boostEnabled} is <b>null</b>; an explicit <b>true</b> or <b>false</b> ignores this value.
 * @example anychart.charts.Cartesian.boostThreshold_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.maxPointsRendered
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Cartesian.maxPointsRendered_get
 * @return {number} The current value.
 * @since 9.0.0
 */
anychart.charts.Cartesian.prototype.maxPointsRendered;
...
/**
 * Setter for the largest number of points drawn per series; above it the series is decimated for display, which does not change the underlying data.<br/>Set <b>0</b> to switch decimation off entirely. Decimation is also skipped for stacked series, for size-encoded series such as bubble, for heat map series always - thinning selects points along one ordered axis, and a categorical matrix has no midpoint to collapse neighboring cells into - and whenever boost draws the points instead.
 * @example anychart.charts.Cartesian.maxPointsRendered_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Cartesian.prototype.decimationAlgorithm
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.charts.Cartesian.decimationAlgorithm_get
 * @return {anychart.enums.DecimationAlgorithm|string} The current value.
 * @since 9.0.0
 */
anychart.charts.Cartesian.prototype.decimationAlgorithm;
 ...
 * </ul>
 * Learn more about permitted values at {@link anychart.enums.DecimationAlgorithm}
 * @example anychart.charts.Cartesian.decimationAlgorithm_set
 * @param {(anychart.enums.DecimationAlgorithm|string)=} opt_value ['auto'] Value to set.
 * @return {anychart.charts.Cartesian} Self instance for method chaining.
 * @since 9.0.0
 */
anychart.charts.Cartesian.prototype.decimationAlgorithm;
