 ...
 * nodesData.nodes(0, 'shape', 'star5'); //Set shape for first node in dataset
 ...
 *   <br>
 * <ul>
 *   <li><b>node object must contain required 'id' field</b></li>
 *   <li><b>edge object must contain required 'from' and 'to' fields</b></li>
 *   </ul>
 * @return {anychart.charts.Graph} Self instance for method chaining.
 */
anychart.charts.Graph.prototype.data;
