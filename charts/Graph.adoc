...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Graph.prototype.minZoom
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @shortDescription Minimum zoom factor of the chart.
 * @category Interactivity
 * @since 9.0.0
 * @example anychart.charts.Graph.zoomLimits_get
 * @listing See listing
 * var minZoom = chart.minZoom();
 * @return {number} Minimum zoom factor.
 */
anychart.charts.Graph.prototype.minZoom;

/**
 * Setter for the minimum zoom factor.
 * @detailed
 * <ul>
 *   <li><b>Default:</b> 0.4.</li>
 *   <li><b>Unit:</b> the same zoom factor that the zoom() method returns, where 1 is the initial scale of the chart.</li>
 *   <li><b>Scope:</b> the limit applies to every zoom path - mouse wheel, pinch gesture, zoomIn(), zoomOut(), zoom(), and a transformation matrix restored from a saved state.</li>
 *   <li><b>Invalid values:</b> a value that is not a finite number greater than 0 is ignored, and a warning is printed to the console once.</li>
 *   <li><b>Conflicting values:</b> a value greater than an explicitly set maximum is ignored the same way; a value greater than the default maximum is accepted.</li>
 *   <li><b>Serialization:</b> the option is written to JSON only when it is set explicitly.</li>
 * </ul>
 * See {@link anychart.charts.Graph#maxZoom} for the upper limit.
 * @category Interactivity
 * @since 9.0.0
 * @example anychart.charts.Graph.zoomLimits_set
 * @param {number} value [0.4] Minimum zoom factor.
 * @listing See listing
 * chart.minZoom(0.5); // the chart cannot be zoomed out below half of the initial scale
 * @return {anychart.charts.Graph} Self instance for method chaining.
 */
anychart.charts.Graph.prototype.minZoom;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Graph.prototype.maxZoom
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @shortDescription Maximum zoom factor of the chart.
 * @category Interactivity
 * @since 9.0.0
 * @example anychart.charts.Graph.zoomLimits_get
 * @listing See listing
 * var maxZoom = chart.maxZoom();
 * @return {number} Maximum zoom factor.
 */
anychart.charts.Graph.prototype.maxZoom;

/**
 * Setter for the maximum zoom factor.
 * @detailed
 * <ul>
 ...
 *   <li><b>Scope:</b> the limit applies to every zoom path - mouse wheel, pinch gesture, zoomIn(), zoomOut(), zoom(), and a transformation matrix restored from a saved state.</li>
 *   <li><b>Invalid values:</b> a value that is not a finite number greater than 0 is ignored, and a warning is printed to the console once.</li>
 *   <li><b>Conflicting values:</b> a value less than an explicitly set minimum is ignored the same way; a value less than the default minimum is accepted.</li>
 *   <li><b>Serialization:</b> the option is written to JSON only when it is set explicitly.</li>
 * </ul>
 * See {@link anychart.charts.Graph#minZoom} for the lower limit.
 * @category Interactivity
 * @since 9.0.0
 * @example anychart.charts.Graph.zoomLimits_set
 * @param {number} value [100] Maximum zoom factor.
 * @listing See listing
 * chart.maxZoom(4); // the chart cannot be zoomed in above four times the initial scale
 * @return {anychart.charts.Graph} Self instance for method chaining.
 */
anychart.charts.Graph.prototype.maxZoom;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.charts.Graph.prototype.getZoomLevel
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * <ul>
 *   <li><b>Unit:</b> the same zoom factor that the zoom() method returns, where 1 is the initial scale of the chart.</li>
 *   <li><b>Initial value:</b> 1 right after the draw() call.</li>
 * </ul>
 * See {@link anychart.charts.Graph#minZoom} and {@link anychart.charts.Graph#maxZoom} for the limits.
 * @shortDescription Current zoom level of the chart.
 * @category Interactivity
 * @since 9.0.0
 * @example anychart.charts.Graph.getZoomLevel
 * @listing See listing
