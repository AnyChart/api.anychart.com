...
/**
 * 	Event type for the marker at mouse over.
 */
...
/**
 * Event type for axis marker at mouse over.
 */
anychart.enums.EventType.AXIS_MARKER_OVER = 'axisMarkerOver';

/**
 * Event type for axis marker at mouse move.
 */
anychart.enums.EventType.AXIS_MARKER_MOVE = 'axisMarkerMove';

/**
 * Event type for axis marker at mouse out.
 */
