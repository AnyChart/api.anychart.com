...
/**
 * CSV mode enum.
 * @example anychart.enums.CsvMode
 * @enum {string}
 */
anychart.enums.CsvMode;

/**
 * CSV mode for raw data.
 */
anychart.enums.CsvMode.RAW = "raw";

/**
 * Displaying the data used in the current series view, grouped by x or index.
 */
anychart.enums.CsvMode.SPECIFIC = "specific";

/**
 * Grouped CSV mode for use only stock.
 */
anychart.enums.CsvMode.GROUPED = "grouped";
