...
/**
 * Anchor enum. Defines 10 items.<br/>
...
/**
 * Position enum. Defines 10 items. Similar to Anchor. Distinct by meaning.<br/>
 * <img src="/anychart.enums.Anchor.png" width="330" height="180"/>
...
/**
 * Dispatched before updating the periods after period drag.<br/>
 * Works only with the {@link anychart.charts.Gantt#editing} method of the {@link anychart#ganttResource} chart.
 * @category Gantt event types
 * @example anychart.enums.EventType.beforeUpdatePeriod Before Update Period
 */
anychart.enums.EventType.BEFORE_UPDATE_PERIOD = "beforeUpdatePeriod";
...
/**
 * Display mode is sticky-x: the vertical line sticks to the data points, the horizontal line and its Y label follow the pointer.<br/>
 * Supported by Stock plots only; other chart types act as float.
 * @since 9.0.0
 */
anychart.enums.CrosshairDisplayMode.STICKY_X = "sticky-x";
...
/**
 * Dumbbell series type.
 */
anychart.enums.CartesianSeriesType.DUMBBELL = "dumbbell";

/**
 * Lollipop series type.
 */
anychart.enums.CartesianSeriesType.LOLLIPOP = "lollipop";
...
/**
 * Points are displayed as-is, overlapping.
 */
anychart.enums.PolarValuesSpreadType.NONE = "none";

/**
 * Points with the exact same values are spread along the X-Axis.
 * @example anychart.charts.Polar.spreadPoints_set_valueEqual
 */
anychart.enums.PolarValuesSpreadType.VALUE_EQUAL = "valueEqual";

/**
 * Points with the values within the same Y Scale tick are spread along the X-Axis.
 * @example anychart.charts.Polar.spreadPoints_set_value50
 */
anychart.enums.PolarValuesSpreadType.VALUE_50 = "value50";
...
/**
 * Circle packing {api:anychart.charts.CirclePacking#labelsMode}labels mode{api}.
 * @enum {string}
 * @since 8.13.0
 */
anychart.enums.CirclePackingLabelsMode;
...
/**
 * "roots" mode. Labels are shown only on top level.
 */
anychart.enums.CirclePackingLabelsMode.ROOTS = 'roots';

/**
 * "leaves" mode. Labels are shown for child (leaves) elements only.
 */
anychart.enums.CirclePackingLabelsMode.LEAVES = 'leaves';

//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.enums.StreamGraphOffset
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Stream graph {api:anychart.charts.StreamGraph#offset}offset{api} mode.
 * @enum {string}
 * @since 9.0.0
 */
anychart.enums.StreamGraphOffset;
...
/**
 * "wiggle" mode. Minimizes the wiggle of the layer slopes.
 */
anychart.enums.StreamGraphOffset.WIGGLE = 'wiggle';

/**
 * "silhouette" mode. Centers the stream around the x-axis.
 */
anychart.enums.StreamGraphOffset.SILHOUETTE = 'silhouette';

/**
 * "expand" mode. Normalizes each stack to a constant height, filling the [-0.5, 0.5] band.
 */
anychart.enums.StreamGraphOffset.EXPAND = 'expand';

/**
 * "zero" mode. Plain stacking from the zero baseline.
 */
anychart.enums.StreamGraphOffset.ZERO = 'zero';

//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.enums.OrgChartOrientation
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Org chart {api:anychart.charts.OrgChart#orientation}orientation{api}.
 * @enum {string}
 * @since 9.0.0
 */
anychart.enums.OrgChartOrientation;
 ...
 */
anychart.enums.OrgChartOrientation.TOP_TO_BOTTOM = 'top-to-bottom';

/**
 * The tree grows from the bottom up.
 */
anychart.enums.OrgChartOrientation.BOTTOM_TO_TOP = 'bottom-to-top';

/**
 * The tree grows from left to right.
 */
anychart.enums.OrgChartOrientation.LEFT_TO_RIGHT = 'left-to-right';

/**
 * The tree grows from right to left.
 */
anychart.enums.OrgChartOrientation.RIGHT_TO_LEFT = 'right-to-left';

//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.enums.OrgChartConnectorType
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Org chart {api:anychart.charts.OrgChart#connectorType}connector type{api}.
 * @enum {string}
 * @since 9.0.0
 */
anychart.enums.OrgChartConnectorType;
...
/**
 * Connectors are drawn with right-angle segments.
 */
anychart.enums.OrgChartConnectorType.ORTHOGONAL = 'orthogonal';

/**
 * Connectors are drawn as straight lines.
 */
anychart.enums.OrgChartConnectorType.STRAIGHT = 'straight';

/**
 * Connectors are drawn as curved lines.
 */
anychart.enums.OrgChartConnectorType.CURVED = 'curved';

//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.enums.DecimationAlgorithm
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Cartesian chart {api:anychart.charts.Cartesian#decimationAlgorithm}decimation algorithm{api} applied when a series
 * holds more points than the {api:anychart.charts.Cartesian#maxPointsRendered}maximum rendered points{api} value allows.
 * @enum {string}
 * @since 9.0.0
 */
anychart.enums.DecimationAlgorithm;
...
/**
 * Picks 'min-max' for discrete series, the ones that draw a separate mark per point,
 * and 'lttb' for continuous ones (line, area).
 */
anychart.enums.DecimationAlgorithm.AUTO = 'auto';

/**
 * Largest-Triangle-Three-Buckets - keeps the visual shape of the curve.
 */
anychart.enums.DecimationAlgorithm.LTTB = 'lttb';

/**
 * Keeps the extremes of every bucket, so peaks and troughs survive.
 */
anychart.enums.DecimationAlgorithm.MIN_MAX = 'min-max';

//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.enums.BoundsMode
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Chart content bounds mode applied while panning, supported by
 * {api:anychart.core.orgChart.Interactivity#boundsMode}Org Chart{api} and
 * {api:anychart.core.graph.elements.Interactivity#boundsMode}Network Graph{api} interactivity.
 * @enum {string}
 * @since 9.0.0
 */
anychart.enums.BoundsMode;
...
/**
 * The content is panned without any limits.
 */
anychart.enums.BoundsMode.FREE = 'free';

/**
 * The content is clamped to the chart area on every step of a gesture; when the content is bigger than the area,
 * its far edge stops at the edge of the area.
 */
anychart.enums.BoundsMode.CONTAIN = 'contain';

/**
 * The content animates back to the center when a gesture leaves it fully out of the chart area.
 */
anychart.enums.BoundsMode.AUTO_CENTER = 'auto-center';
