...
/**
 * Displaying the data used in the current series view, grouped by x.
 */
anychart.enums.ChartDataExportMode.SPECIFIC = "default";
...
/**
 * Selected data export mode for use only stock.
 */
