 ...
 * Works only with {api:anychart.core.Chart#startSelectMarquee}.startSelectMarquee(){api} method.
 * @category Marquee event types
 * @example anychart.enums.EventType.selectMarqueeStartSelectMarqueeFinish Select Marquee Start
 */
 ...
 * Works only with {api:anychart.core.Chart#startSelectMarquee}.startSelectMarquee(){api} method.
 * @category Marquee event types
 * @example anychart.enums.EventType.selectMarqueeStartSelectMarqueeFinish Select Marquee Finish
 */
