...
/**
 * Layout for radial and polar grids.
 ...
 * Range Column series type.
 */
anychart.enums.PolarSeriesType.RANGE_COLUMN = "rangeColumn";
 ...
 * ByWord mode.
 */
anychart.enums.TextParsingMode.BY_WORD = "byWord";

/**
 * ByChar mode.
 */
anychart.enums.TextParsingMode.BY_CHAR = "byChar";
