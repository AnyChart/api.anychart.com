 ...
 * @param {function(context)} function Function that looks like: <pre>function(context){
 ...
 * @param {function(anychart.data.TableComputer.RowProxy,context)} value Function that looks like: <pre>function(anychart.data.TableComputer.RowProxy, context){
 *    // this: context - The context value from {@link anychart.data.TableComputer#setContext} method
 * }</pre>
 * @since 7.9.0
 */
