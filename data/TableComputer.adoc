 ...
 * @param {StartFunction} function Function that looks like: <pre>function(context){
 ...
 * @param {CalculationFunction} value Function that looks like: <pre>function(anychart.data.TableComputer.RowProxy, context){
 *    // this: context - The context value from {@link anychart.data.TableComputer#setContext} method
 * }</pre>
 * @since 7.9.0
 */
