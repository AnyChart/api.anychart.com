 ...
 *     // 'close' is an element with the index of 3.
 *     // All elements with the index greater than 3 are ignored.
 * @param {(Array|string)=} opt_data Dataset raw data can be set here.
 ...
 * @param {(Array|string)=} opt_data Dataset raw data can be set here.
 * @param {(anychart.enums.TextParsingMode|string|anychart.data.TextParsingSettings)=} opt_settings If CSV string is passed, you can pass CSV parser settings
 *    here as a hash map.
 ...
 * For example, the "population" field of the raw data is generated by the "size" field of the chart data.
