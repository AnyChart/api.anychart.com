 ...
 * @param {FilterViewFunction} filterFunction A filter function that should accept a field value and return true if the row
 *  should be included in the resulting view.
 * @return {!anychart.data.View} The new derived filtered view.
 */
anychart.data.View.prototype.filter;
 ...
 * @param {SortingFunction=} opt_comparator A sorting function that should accept two field values and return the
 * numeric result of the comparison.
 * @return {!anychart.data.View} The new derived sorted view.
 */
anychart.data.View.prototype.sort;
 ...
 * @return {!anychart.data.View} The new derived concatenated view.
 */
anychart.data.View.prototype.concat;
 ...
 * @param {number} rowIndex Row index to set.
 ...
 * @category Data
 * @return {Array.<anychart.data.Set>} Parent data sets.
 * @since 7.11.0
 */
anychart.data.View.prototype.getDataSets;
