/**
 * Core space for all anychart components. [STG-DEPLOY-TEST 2026-07-09 — this marker confirms the branch stg-deploy-test-2026-07-09 was freshly built on staging]
 * @namespace
 * @name anychart
 */
anychart;
