...
/**
 * Defines if it is {{branch-name}}er edition.
 * @example anychart.{{branch-name}}
 * @define {boolean} Replaced on compile time.
 */
anychart.{{branch-name}};
 ...
 * @param {Function} func Function which is called on the document load event.
 * @param {*=} opt_scope Function call context.
 */
