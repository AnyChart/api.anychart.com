 ...
 * @param {!anychart.data.TableMapping} mapping Data mapping
 * @param {number=} opt_period [25] Period
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.aroonOscillator
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Technical Indicators
 * @example anychart.core.stock.Plot.aroonOscillator
 * @param {!anychart.data.TableMapping} mapping Data mapping
 * @param {number=} opt_period [25] Period
 * @param {anychart.enums.StockSeriesType|string=} opt_seriesType ["area"] Series type for the Aroon Oscillator indicator.
 * @return {anychart.core.stock.indicators.AroonOscillator} Returns Aroon Oscillator indicator.
 * @since 8.11.1
 */
anychart.core.stock.Plot.prototype.aroonOscillator;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.coppockCurve
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Technical Indicators
 * @example anychart.core.stock.Plot.coppockCurve
 * @param {!anychart.data.TableMapping} mapping Data mapping.
 ...
 * @param {anychart.enums.StockSeriesType|string=} opt_seriesType Series type.
 * @return {anychart.core.stock.indicators.CoppockCurve} Returns a Coppock Curve indicator.
 * @since 8.11.1
 */
anychart.core.stock.Plot.prototype.coppockCurve;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.wma
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Technical Indicators
 * @example anychart.core.stock.Plot.wma
 * @param {!anychart.data.TableMapping} mapping Data mapping.
 * @param {number=} opt_period [9] Period.
 * @param {(anychart.enums.StockSeriesType|string)=} opt_seriesType ["line"] Series type for WMA indicator (type as "line", "column", "area").
 * @return {anychart.core.stock.indicators.WMA} Returns WMA (Weighted Moving Average) indicator.
 * @since 8.11.1
 */
anychart.core.stock.Plot.prototype.wma;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.vwap
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Technical Indicators
 * @example anychart.core.stock.Plot.vwap
 * @param {!anychart.data.TableMapping} mapping Data mapping.
 * @param {anychart.enums.StockSeriesType|string=} opt_vwapSeriesType ['line'] Indicator series type.
 * @return {anychart.core.stock.indicators.VWAP} Returns VWAP indicator.
 * @since 8.8.1
 */
anychart.core.stock.Plot.prototype.vwap;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.moveUp
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @example anychart.core.stock.Plot.plots_position
 * @return {anychart.core.stock.Plot} Plot instance for method chaining.
 */
anychart.core.stock.Plot.prototype.moveUp;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.moveDown
//
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.toggleExpandedState
//
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.stock.Plot.prototype.isExpanded
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Size and Position
 * @example anychart.core.stock.Plot.plots_position
 * @return {boolean} Whether the plot is expanded.
 */
anychart.core.stock.Plot.prototype.isExpanded;
