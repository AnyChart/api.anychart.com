 ...
 * The following series are allowed to switch using the allowPointSettings flag:
 * <ul>
 ...
 * </ul>
 * If the value isn't set to {@link anychart.core.stock.series.Base#allowPointSettings} then the series accept the settings from {@link anychart#stock}.<br/>
 * <b>Note</b>: The remaining series cannot be affected by the allowPointSettings flag. This series are always drawn as a continuous or discrete series.
 * @example anychart.core.stock.series.Base.allowPointSettings
 * @param {boolean=} opt_enabled [false] Allows to change the series drawing to a discrete or continuous type.
 * If set to 'true' - discrete series, if set to 'false' - continuous series.
 * @return {anychart.core.stock.series.Base} Self instance for method chaining.
 * @since 8.2.1
 */
anychart.core.stock.series.Base.prototype.allowPointSettings;
