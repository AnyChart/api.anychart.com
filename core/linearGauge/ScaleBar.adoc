 ...
 * @param {(string|number)=} opt_fromValue 'From' value to set. In case of string it can be 'max' or 'min'.
 * In case of number - ratio (from 0 to 1).
 ...
 * @param {(string|number)=} opt_toValue 'To' value to set. In case of string it can be 'max' or 'min'.
 * In case of number - ratio (from 0 to 1).
 * @return {anychart.core.linearGauge.ScaleBar} Self instance for method chaining.
 * @since 7.11.0
 */
 ...
 * @param {anychart.scales.Base=} opt_scale [{api:anychart.scales.Linear}anychart.scales.Linear{api}] Scale for the scale bar.
 ...
 * @param {(anychart.scales.LinearColor|anychart.scales.OrdinalColor|Object|anychart.enums.ScaleTypes|string)=} opt_settings Color scale settings.
 * @return {anychart.core.linearGauge.ScaleBar} Self instance for method chaining.
 * @since 7.11.0
 */
anychart.core.linearGauge.ScaleBar.prototype.colorScale;
 ...
 * @example anychart.core.linearGauge.ScaleBar.fill_set_asObj Using object
 ...
 * @param {Array.<anychart.core.linearGauge.ScaleBar.ControlPoint>=} opt_pointsList Points to set.
 * @return {anychart.core.linearGauge.ScaleBar} Self instance for method chaining.
 * @since 7.11.0
 */
anychart.core.linearGauge.ScaleBar.prototype.points;
 ...
 * @param {string=} opt_width ['10%'] Width in pixel or percent.
 * @return {anychart.core.linearGauge.ScaleBar} Self instance for method chaining.
 * @since 7.11.0
 */
anychart.core.linearGauge.ScaleBar.prototype.width;
 ...
 * @param {string=} opt_offset ['0%'] Offset value in percent.
 * @return {anychart.core.linearGauge.ScaleBar} Self instance for method chaining.
 * @since 7.11.0
 */
anychart.core.linearGauge.ScaleBar.prototype.offset;
...
/** @inheritDoc */
anychart.core.linearGauge.ScaleBar.prototype.zIndex;
