...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.scatter.series.Base.prototype.boostEnabled
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.core.scatter.series.Base.boostEnabled_get
 ...
 * @example anychart.core.scatter.series.Base.boostEnabled_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.scatter.series.Base.prototype.boostThreshold
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.core.scatter.series.Base.boostThreshold_get
...
/**
 * Setter for the number of points above which boost switches on automatically.<br/>Only consulted while {@link anychart.core.scatter.series.Base#boostEnabled} is <b>null</b>; an explicit <b>true</b> or <b>false</b> ignores this value.
 * @example anychart.core.scatter.series.Base.boostThreshold_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.scatter.series.Base.prototype.maxPointsRendered
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.core.scatter.series.Base.maxPointsRendered_get
 * @return {number} The current value.
 * @since 9.0.0
 */
anychart.core.scatter.series.Base.prototype.maxPointsRendered;
 ...
 * @example anychart.core.scatter.series.Base.maxPointsRendered_set
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.scatter.series.Base.prototype.decimationAlgorithm
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @category Specific settings
 * @example anychart.core.scatter.series.Base.decimationAlgorithm_get
 ...
 * @example anychart.core.scatter.series.Base.decimationAlgorithm_set
