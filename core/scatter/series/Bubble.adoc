 ...
 * @param {anychart.graphics.vector.StrokeLineCap=} opt_lineCap Line cap style.
 * @return {anychart.core.scatter.series.Bubble|anychart.graphics.vector.Stroke|Function} .
 */
 ...
 * @param {number=} opt_fx .
 * @param {number=} opt_fy .
 * @return {anychart.graphics.vector.Fill|anychart.core.scatter.series.Bubble|Function} .
 */
 ...
 * @param {number=} opt_thickness Thickness.
 * @param {number=} opt_size Pattern size.
 * @return {anychart.graphics.vector.PatternFill|anychart.graphics.vector.HatchFill|anychart.core.scatter.series.Base|Function|boolean} Hatch fill.
 */
