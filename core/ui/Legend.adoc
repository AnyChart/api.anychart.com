 ...
 * <b>Note:</b> Can be called  <b>chart.draw()</b>, but changes will be applied only after <b>chart.draw()</b>
 * @example anychart.core.ui.Legend.position_set_asObject
 * @param {{x: (number|string), y: (number|string)}} opt_position Object with position coordinates.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
