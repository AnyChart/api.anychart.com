 ...
 * @param {(number|string)=} opt_left Left coordinate.
 ...
 * @param {anychart.math.Rect=} opt_bounds Object with bounds settings.
 * @param {(number|string)=} opt_top Top coordinate.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
anychart.core.ui.Legend.prototype.currentPixelBounds;
 ...
 * @param {({left: number, top: number}|{x: number, y: number}|{left: string, top: string}|{x: string, y: string})=} opt_bounds Object with bounds settings.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
anychart.core.ui.Legend.prototype.currentPixelBounds;
