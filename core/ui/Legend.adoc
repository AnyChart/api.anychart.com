...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.ui.Legend.prototype.currentPixelBounds
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the actual pixel bounds of the legend.
 * <b>Note:</b> works only after <b>chart.draw()</b>
 * @shortDescription Actual legend pixel bounds settings.
 * @category Size and Position
 * @example anychart.core.ui.Legend.currentPixelBounds_get
 * @return {(anychart.math.Rect)} Items layout.
 */
anychart.core.ui.Legend.prototype.currentPixelBounds;

/**
 * Setter for the actual pixel bounds of the legend.
 * <b>Note:</b> works only after <b>chart.draw()</b>
 * @example anychart.core.ui.Legend.currentPixelBounds_set_asNumberOrString
 * @param {(number|string)=} opt_boundsOrLeft Left coordinate.
 ...
 * Setter for the actual pixel bounds of the legend.
 * <b>Note:</b> works only after <b>chart.draw()</b>
 * @example anychart.core.ui.Legend.currentPixelBounds_set_asRect
 * @param {goog.math.Rect=} opt_boundsOrLeft Object with bounds settings.
 * @param {(number|string)=} opt_top Top coordinate.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
anychart.core.ui.Legend.prototype.currentPixelBounds;
 ...
 * Setter for the actual pixel bounds of the legend.
 * <b>Note:</b> works only after <b>chart.draw()</b>
 * @example anychart.core.ui.Legend.currentPixelBounds_set_asObject
 * @param {({left: number, top: number}|{x: number, y: number}|{left: string, top: string}|{x: string, y: string})=} opt_boundsOrLeft Object with bounds settings.
 * @param {(number|string)=} opt_top Top coordinate.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
anychart.core.ui.Legend.prototype.currentPixelBounds;
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.ui.Legend.prototype.resetPixelBounds
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Resets pixel bounds and related drag state to initial values.
 * @example anychart.core.ui.Legend.resetPixelBounds
