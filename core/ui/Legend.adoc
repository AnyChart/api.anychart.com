...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.ui.Legend.prototype.getCurrentPosition
//
//----------------------------------------------------------------------------------------------------------------------

/**
 * Getter for the current position of the legend.
 * <b>Note:</b> works only after <b>chart.draw()</b>, will return <i>null</i> if called before <b>chart.draw()</b>
 * @shortDescription Actual legend pixel bounds settings.
 * @category Size and Position
 * @example anychart.core.ui.Legend.getCurrentPosition_get
 * @return {?({x: number, y: number})} Items position.
 */
anychart.core.ui.Legend.prototype.getCurrentPosition;
...
/**
 * Setter for legend position coordinates.
 * <b>Note:</b> Can be called before <b>chart.draw()</b>, but changes will be applied only after <b>chart.draw()</b>
 * @example anychart.core.ui.Legend.position_set_asObject
 * @param {({x: number, y: number})=} opt_position Object with position coordinates like {x: 0, y: 0}.
 * @return {anychart.core.ui.Legend} Self instance for method chaining.
 */
anychart.core.ui.Legend.prototype.position;
