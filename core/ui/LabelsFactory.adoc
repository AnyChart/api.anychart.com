 ...
 * @example anychart.core.ui.LabelsFactory.textFormatter_set_asFunc Using function
 * @example anychart.core.ui.LabelsFactory.textFormatter_set_asString Using string
 * @param {(Function|string)=} opt_value [function() {return this['value'];}] Function or string token to format content label text.
 * @return {anychart.core.ui.LabelsFactory} Self instance for method chaining.
 */
anychart.core.ui.LabelsFactory.prototype.textFormatter;
