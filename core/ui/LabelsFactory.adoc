 ...
 * </td><td><p>{@link anychart.enums.PyramidLabelsPosition}|string</p>
 * </td>
 * </tr><tr><td><p>anychart.charts.Sunburst</p>
 * </td><td><center><p>'circular'</p></center>
 * </td><td><p>'circular', 'radial'</p>
 * </td>
 * </tr><tr><td><p>anychart.charts.CirclePacking</p>
 * </td><td><center><p>'center-top'</p></center>
 * </td><td><p>{@link anychart.enums.Position}|string</p>
 * </td>
 * </tr><tr><td><p>anychart.charts.OrgChart</p>
 * </td><td><center><p>value not set</p></center>
 * </td><td><p>not used, the labels are placed inside the node box</p>
 * </td>
 * </tr><tr><td><p>anychart.core.arcDiagram.elements.Node</p>
 * </td><td><center><p>value not set</p></center>
 * </td><td><p>not used, the labels are placed along the node line and turned with rotation()</p>
 * </td>
 ...
 * </td>
 * </tr><tr><td><p>anychart.core.dependencyWheel.elements.Node</p>
 * </td><td><center><p>'circular'</p></center>
 * </td><td><p>'circular', 'tangential'</p>
 * </td>
 ...
 * </tr>
 * </table>
 * Series labels take one more value on top of the table above:
 * <ul>
 *   <li><b>'rangeMode'</b> - the point is labeled at both of its ends instead of at one end alone: two labels are drawn, one at the high end and one at the low end. It is meant for the series whose point spans two values - rangeColumn, rangeBar, rangeArea, rangeSplineArea, rangeStepArea, hilo, dumbbell, candlestick, ohlc and box. On a single-value series both ends resolve to the same point, so the two labels print the same value and sit adjacent to each other - one above and one below on column-like series, side by side on bar.</li>
 * </ul>
 * In 'rangeMode' a format function is called once per label of the pair and reads the end it is rendering from this['rangeEnd'], which is 'low' on the low-end label and undefined on the high-end one; a format string cannot tell the two apart.<br/>
 * The default label text follows the end it belongs to on rangeColumn, rangeBar, rangeArea, rangeSplineArea, rangeStepArea, hilo and dumbbell; a series that brings a default label format of its own (candlestick, ohlc, box) prints that same text at both ends.
 * {@link anychart.format.Context}
 ...
 * @example anychart.core.ui.LabelsFactory.position_set_auto_for_continuous_series Sample 'auto' position for continuous series.
...
//----------------------------------------------------------------------------------------------------------------------
//
//  anychart.core.ui.LabelsFactory.prototype.maxLength
//
//----------------------------------------------------------------------------------------------------------------------
 ...
 * @listing See listing
 * var maxLengthValue = chart.labels().maxLength(); // null by default.
 *
 * @shortDescription Maximum text length.
 * @category Base Text Settings
 * @example anychart.core.ui.LabelsFactory.maxLength_get
 ...
 * @listing See listing
 * chart.labels().maxLength(20); // Limit characters count of all chart labels.
 *
 * @shortDescription Limit characters length of the text and append ellipsis to it.
 * @example anychart.core.ui.LabelsFactory.maxLength_timeline_set Timeline chart example.
 * @example anychart.core.ui.LabelsFactory.maxLength_gantt_set Gantt chart example.
 * @example anychart.core.ui.LabelsFactory.maxLength_set Setup and reset example.
 *
