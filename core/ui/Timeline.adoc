 ...
 * @detailed Sets line marker settings depend on of parameter's type:
 * <ul>
 ...
 * @detailed Sets range marker settings depend on of parameter's type:
 * <ul>
 ...
 * @detailed Sets text marker settings depend on of parameter's type:
 * <ul>
