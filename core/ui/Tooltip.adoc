 ...
 * When the HTML tooltip mode is set to <b>true</b> AnyСhart Сomponent installs default tooltip CSS classes.
 ...
 * Enable HTML-mode for the tooltip with {api:anychart.core.ui.Tooltip#useHtml}tooltip.useHtml(true){api} tо work with onDomReady().<br/>
 * <br/>
 ...
 * Enable HTML-mode for the tooltip with {api:anychart.core.ui.Tooltip#useHtml}tooltip.useHtml(true){api} tо work with onBeforeTitleChange().<br/>
 * <br/>
 ...
 * Enable HTML-mode for the tooltip with {api:anychart.core.ui.Tooltip#useHtml}tooltip.useHtml(true){api} tо work with onTitleChanged().<br/>
 * <br/>
 ...
 * Enable HTML-mode for the tooltip with {api:anychart.core.ui.Tooltip#useHtml}tooltip.useHtml(true){api} tо work with onBeforeContentChange().<br/>
 * <br/>
 * The handler is called before changes are applied.<br/>
 ...
 * Enable HTML-mode for the tooltip with {api:anychart.core.ui.Tooltip#useHtml}tooltip.useHtml(true){api} tо work with onContentChanged().<br/>
 * <br/>
