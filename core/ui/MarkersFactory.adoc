 ...
 * @detailed This method works for discrete series (bar, column) and has additional 'rangeMode' for range series (rangeArea, rangeColumn). 
 ...
 * @shortDescription Markers Z-index.
 * @category Size and Position
 * @listing See listing
 ...
 * @example anychart.core.ui.MarkersFactory.zIndex
 * @param {number=} opt_zIndex [31.000012] Z-index to set.
 * @return {anychart.core.ui.MarkersFactory} Self instance for method chaining.
 */
anychart.core.ui.MarkersFactory.prototype.zIndex;
