 ...
 * @constructor
 * @extends {anychart.core.map.series.BubbleWithMarkers}
 * @since 7.7.0
 */
 ...
 * @param {(anychart.graphics.vector.HatchFill.HatchFillType|string)=} opt_type [false] Type or state of hatch fill.
