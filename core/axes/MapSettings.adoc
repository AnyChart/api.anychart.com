...
/**
 * Setter for axes title.
 * @detailed Sets axes title settings depending on parameter type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable axes title.</li>
 *   <li><b>string</b> - sets axes title text value.</li>
 *   <li><b>object</b> - sets axes title settings.</li>
 * </ul>
...
/**
 * Getter for axes labels.
 * @shortDescription Labels settings.
 * @category Labels
 * @example anychart.core.axes.MapSettings.labels_get
 * @return {!anychart.core.ui.LabelsFactory} Axes labels instance.
 * @since 7.12.0
 */
anychart.core.axes.MapSettings.prototype.labels;

/**
 * Setter for axes labels.
 * @detailed Sets axes labels settings depending on parameter type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable axes labels.</li>
 *   <li><b>object</b> - sets axes labels settings.</li>
 * </ul>
...
/**
 * Setter for axes minor labels.
 * @detailed Sets axes minor labels settings depending on parameter type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable axes minor labels.</li>
 *   <li><b>object</b> - sets axes minor labels settings.</li>
 * </ul>
...
/**
 * Setter for axes ticks.
 * @detailed Sets axes ticks settings depending on parameter type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable axes ticks.</li>
 *   <li><b>object</b> - sets axes ticks settings.</li>
 * </ul>
...
/**
 * Setter for minor axes ticks.
 * @detailed Sets axes minor ticks settings depending on parameter type:
 * <ul>
 *   <li><b>null/boolean</b> - disable or enable axes minor ticks.</li>
 *   <li><b>object</b> - sets axes minor ticks settings.</li>
 * </ul>
...
/**
 * Getter for axes stroke settings.
...
/**
 * Setter for axes stroke settings.
...
/**
 * Getter for the axes enabled state.
 * @category Specific settings
 * @shortDescription Disable or enable axes.
 * @return {boolean} Axes enabled state.
 * @since 7.12.0
 */
anychart.core.axes.MapSettings.prototype.enabled;

/**
 * Setter for the axes enabled state.
