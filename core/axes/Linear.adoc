 ...
 * @detailed Sets axis title settings depend on of parameter's type:
 * <ul>
 ...
 * @param {(anychart.graphics.vector.Stroke|anychart.graphics.vector.ColoredFill|string|Function|null)=} opt_value ['#474747'] Stroke settings.
