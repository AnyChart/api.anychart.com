...
/**
 * Getter for hover hatch fill settings in hover mode.
 ...
 * @return {!anychart.graphics.vector.Fill} The fill color in hover mode.
 */
anychart.core.cartesian.series.Area.prototype.hoverFill;
...
/**
 * Setter for the stroke by function in selected mode.
