 ...
 * @return {anychart.graphics.vector.Stroke|Function} High stroke settings in hover mode.
 */
anychart.core.cartesian.series.RangeArea.prototype.hoverHighStroke;
 ...
 * @return {anychart.graphics.vector.Stroke|Function} Low stroke settings in hover mode.
 */
anychart.core.cartesian.series.RangeArea.prototype.hoverLowStroke;
 ...
 * @return {!anychart.graphics.vector.Fill} Fill color in hover mode.
 */
anychart.core.cartesian.series.RangeArea.prototype.hoverFill;
