 ...
 * @shortDescription Median stroke setting on hover state.
 * @category Coloring
 ...
 * @shortDescription Stem stroke settings on hover state.
 * @category Coloring
 ...
 * @shortDescription Whisker settings on hover state.
 * @category Coloring
 ...
 * @shortDescription Outlier markers settings on hover state.
 * @category Point Elements
