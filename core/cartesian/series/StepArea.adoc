 ...
 * {docs:Basic_Charts_Types/Stacked_Area-SplineArea_Charts}Learn more about SplineArea series{docs}
 ...
 * @return {anychart.graphics.vector.PatternFill|anychart.graphics.vector.HatchFill|Function} Hover hatch fill setiings.
 */
anychart.core.cartesian.series.StepArea.prototype.hoverHatchFill;
...
/**
 * Getter for select hatch fill settings in selected mode.
