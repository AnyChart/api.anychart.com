 ...
 * {docs:Basic_Charts_Types/Range_Area-SplineArea_Charts}Learn more about RangeSplineArea series{docs}
...
/**
 * Setter for the series low stroke in hover mode by function.
