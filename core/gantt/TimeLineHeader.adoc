 ...
 * @listing See listing
 * var timeLine = chart.getTimeline();
 * var currentHeight = timeLine.levelHeight();
 ...
 * @shortDescription Padding settings
 * @category Specific settings
 * @return {anychart.core.gantt.TimeLineLevelHolidaysSettings} Holidays settings.
 * @since 8.2.0
 */
anychart.core.gantt.TimeLineHeader.prototype.holidays;
 ...
 * @return {anychart.core.gantt} Overlay element.
 * @since 8.2.0
 */
anychart.core.gantt.TimeLineHeader.prototype.overlay;
