 ...
 * @param {anychart.graphics.vector.Fill} opt_value ["#FFFFFF"] Color as an array or a string.
 * @return {anychart.core.grids.Linear} Self instance for method chaining.
 */
anychart.core.grids.Linear.prototype.oddFill;
 ...
 * Layout is define by method {@link anychart.core.grids.Linear#layout}.
