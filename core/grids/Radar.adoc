 ...
 * @param {(anychart.enums.RadialGridLayout|string)=} opt_value Grid layout.
 ...
 * @param {anychart.graphics.vector.Fill} opt_value ["white"] Color as an array or a string.
 * @return {anychart.core.grids.Radar} Self instance for method chaining.
 */
anychart.core.grids.Radar.prototype.oddFill;
 ...
 * @param {anychart.graphics.vector.Fill} opt_value ["Rgb(250,250,250)"] Color as an array or a string.
 * @return {anychart.core.grids.Radar} Self instance for method chaining.
 */
anychart.core.grids.Radar.prototype.evenFill;
