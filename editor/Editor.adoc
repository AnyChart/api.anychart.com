 ...
 * https://cdn.anychart.com/releases/8.8.0/js/anychart-editor.min.js)</i>
 * @category Reference
 ...
 * (example for the versioned file: https://cdn.anychart.com/releases/8.8.0/js/anychart-editor.min.js)</i>
